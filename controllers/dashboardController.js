...
const homeload = async (req, res) => {
  try {
    ...
    console.log(JSON.stringify(obj),"workeeeedddddddddd")
    console.log(obj,"workeeeedddddddddd11111111111111111111111111")
    console.log(obj[0].category,"category ")

    console.log(categorysale,"categorysale totalllllll ");
    ...
    console.log(orderCounts,"ordercounttttt")
...
const getOrders = async (req, res) => {
  try {
    ...
    console.log(fromDate,"1111111111")
    const toDate = req.body.toDate;
    console.log(toDate,"222222222")
...
const yearlysales = async (req, res) => {
  try {
    ...
    console.log(yearlyorders,"yyyyyyy")
